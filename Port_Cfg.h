...
#define PORT_CONFIGURED_CHANNLES              (11U)
...
#define PortConf_PORTF_PIN0_ID (Port_PinType)0 /*Sw2*/
#define PortConf_PORTF_PIN1_ID (Port_PinType)1 /* Red LEd*/
#define PortConf_PORTF_PIN2_ID (Port_PinType)2 /* BLUE LEd*/
#define PortConf_PORTF_PIN3_ID (Port_PinType)3/* Green Led*/
...
#define PortConf_PORTA_PIN0_ID_INDEX (uint8)10
#define PortConf_PORTA_PIN1_ID_INDEX (uint8)9
...
#define PortConf_PORTB_PIN4_ID_INDEX (uint8)0
#define PortConf_PORTB_PIN5_ID_INDEX (uint8)1
...
#define PortConf_PORTE_PIN2_ID_INDEX (uint8)2
#define PortConf_PORTE_PIN3_ID_INDEX (uint8)3
/*#define PortConf_PORTE_PIN4_ID_INDEX (uint8)36
#define PortConf_PORTE_PIN5_ID_INDEX (uint8)37*/

#define PortConf_PORTF_PIN0_ID_INDEX (uint8)4 /*Sw2*/
#define PortConf_PORTF_PIN1_ID_INDEX (uint8)5 /*Led 1 */
#define PortConf_PORTF_PIN2_ID_INDEX (uint8)6
#define PortConf_PORTF_PIN3_ID_INDEX (uint8)7
#define PortConf_PORTF_PIN4_ID_INDEX (uint8)8 /*SW1 */
