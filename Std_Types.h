...
#define STD_TRUE     0x01U       /* Logical state active */
#define STD_FALSE        0x00U       /* Logical state idle */

#define STD_ON          0x01U       /* Standard ON */
#define STD_OFF         0x00U       /* Standard OFF */

#define LOGIC_HIGH        0x01U       /* Standard ON */
#define LOGIC_LOW         0x00U       /* Standard OFF */
